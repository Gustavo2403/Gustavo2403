...
Atualmente atuo como auxiliar de cartório, em processo de evolução para a função de escrevente. Iniciei nessa área por conta da falta de oportunidade imediata na área de tecnologia após minha formação, mas sempre mantive meu objetivo de ingressar como desenvolvedor.

Mesmo fora da área, desenvolvi disciplina, responsabilidade e comprometimento — qualidades que aplico diariamente na minha transição para a tecnologia.
